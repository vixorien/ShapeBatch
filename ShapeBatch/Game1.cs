...
namespace ShapeBatch
{
	public class Game1 : Game
	{
		...
		public void DrawExampleShapes(GameTime gt)
		{
			...
			ShapeBatch.Line(new Vector2(50, 150), new Vector2(150, 220), 8.0f, Color.GreenYellow);
			ShapeBatch.Line(new Vector2(100, 250), 75.0f, rotation, Color.DarkKhaki);
			ShapeBatch.Line(new Vector2(100, 350), 75.0f, rotation + MathF.PI / 2.0f, 10.0f, Color.Purple);

			// Boxes
			ShapeBatch.Box(200, 50, 50, 50, Color.IndianRed);
			ShapeBatch.Box(new Rectangle(220, 150, 50, 60), Color.PapayaWhip);

			// Outline boxes
			ShapeBatch.BoxOutline(200, 250, 50, 50, Color.Gainsboro);
			ShapeBatch.BoxOutline(new Rectangle(220, 350, 75, 60), Color.LawnGreen);

			// Circles
			ShapeBatch.Circle(new Vector2(350, 75), sinWave * 20.0f, Color.Aquamarine);
			...
			// Triangles
			ShapeBatch.Triangle(new Vector2(550, 75), 100, Color.Orange);
			ShapeBatch.Triangle(new Vector2(550, 250), 75, rotation, Color.YellowGreen);
			ShapeBatch.Triangle(new Vector2(550, 475), new Vector2(475, 420), new Vector2(675, 350), Color.CornflowerBlue);

			// Outline triangles
			ShapeBatch.TriangleOutline(new Vector2(650, 150), 60, Color.Orange);
			ShapeBatch.TriangleOutline(new Vector2(650, 275), 60, rotation / -2.0f, Color.YellowGreen);
